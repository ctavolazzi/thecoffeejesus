...
<footer class="footer">
  <div class="footer-content">
    ...
    <GentleBullFundMe />
    <GBCIGEmbed />
    <h2 class="text-2xl font-bold margin-top-10">Your Donation Directly Supports:</h2>
    <h2 class="text-2xl font-bold">Small Businesses</h2>
    <h2 class="text-2xl font-bold">Families in Need,</h2>
    <h2 class="text-2xl font-bold">and Creative Entrepreneurs Around the World.</h2>
    <!-- <ul>
